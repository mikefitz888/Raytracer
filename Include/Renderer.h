...
namespace RENDERER {
	...
	vec3 finalGather(vec3 point, size_t intersecting_triangle_id, std::vector<Triangle>& triangles, PhotonMap& photon_map, PhotonMapper& photon_mapper, size_t depth = 1, size_t secondary_rays = 10);
